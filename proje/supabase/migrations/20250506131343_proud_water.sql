/*
  # Şifreli Oda Sistemi için RLS Politikaları

  1. Değişiklikler
    - chat_room_members için yeni politikalar
    - Şifreli oda erişimi için düzeltmeler
    - Sonsuz döngü sorununu çözme

  2. Güvenlik
    - Şifreli odalara erişim kontrolü
    - Üyelik yönetimi
    - Mesaj erişimi
*/
